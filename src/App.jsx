  ...
  return (
    ...
    <div className='mx-3 md:container md:mx-auto rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[35%]'>
     ...
     <div className='addTodos my-5 flex flex-col gap-4'>
      ...
      <button onClick={handleAdd} disabled={todo.length<= 3} className='bg-violet-800 mx-2 rounded-full hover:bg-violet--950 disabled:bg-violet-700 p-4 py-2 text--sm font-bold text-white'><label className='mx-2' htmlFor="show"></label>Save</button>
      </div>
      </div>
      ...
      <div className='todos'>
        ...
        {todos.map(item=>{
          ...
          return (showFinished || !item.isCompleted) &&  <div key={item.id} className='todo flex my-3 justify-between'>
            ...
            <input name={item.id} onChange={handleCheckBox} type='checkbox' checked={item.inCompleted} id=''/>
